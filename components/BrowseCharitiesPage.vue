<template>
  <div class="charity-page browse-page">
    <my-header />
      ...
      <v-container>
        <v-row>
          <v-col class="d-flex">
            <span
              @click="toggle"
              :class="isExist ? 'active' : ''"
              class="align-self-center relative"
            >
              Browse by category
            </span>
            <v-checkbox
              ...
              class="mt-0 pl-6 cause-checkbox align-self-center"
              hide-details
            ></v-checkbox>
            <v-checkbox
              label="Claimed by charity"
              color="indigo"
              value="Claimed by charity"
              class="mt-0 pl-6 cause-checkbox align-self-center"
              hide-details
            ></v-checkbox>
          </v-col>
